...
class kerucut_ilhamFix:
    ...
    def aturKomponen(self):
        ...
        tinggi = Label(mainFrame, text="Tinggi Kerucut:")
        tinggi.grid(row=2, column=0, sticky=W, padx=5, pady=5)
        selimut = Label(mainFrame, text="Selimut Kerucut:")
        ...
        self.txtselimut = Entry(mainFrame)
    ...
    def onHitung(self):
        ...
        selimut = float(self.txtselimut.get())
...
if __name__ == '__main__':
    root = Tk()  
    aplikasi = kerucut_ilhamFix(root, "Program Bola")
    root.mainloop() 